...
/**
 * Created by 任彩雨 on 2017/8/9.
 * 验证码工具类
 */
public class CheckCode {

    public static int WIDTH = 60;//验证码宽度
    public static int HEIGHT = 20;//验证码高度
    public static int COLOR_FC_BG = 200;//验证码背景颜色COLOR_FC_BG 应当小于COLOR_BC_BG
    public static int COLOR_BC_BG = 250;//验证码背景颜色COLOR_FC_BG 应当小于COLOR_BC_BG
    public static int COLOR_FC_LINE = 160;//验证码背景干扰线颜色COLOR_FC_LINE 应当小于COLOR_BC_LINE
    public static int COLOR_BC_LINE = 200;//验证码背景干扰线颜色COLOR_FC_LINE 应当小于COLOR_BC_LINE
    public static int COLOR_FC_CODE = 20;//验证码颜色COLOR_FC_CODE 应当小于COLOR_BC_CODE
    public static int COLOR_BC_CODE = 170;//验证码颜色COLOR_FC_CODE 应当小于COLOR_BC_CODE
    ...
    public static boolean getImage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        //将生成的验证码数据放到session中去
        request.getSession().setAttribute("codeValue", codeValue);
        System.out.println("生成的验证码是：" + codeValue);
        // 图象生效
        img.dispose();
        // 输出图象到页面
